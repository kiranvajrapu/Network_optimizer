...
def RL_TDD_TO_3G2G():
    ...
    ds = ds[(ds['Message Type'] == 'Paging (PCCH)')| (ds['Message Type'] == 'System Information Block Type1 (DL-BCCH-SCH)') | (ds['Message Type'] == 'System Information (BCCH-BCH)') | (ds['Message Type'] == 'UL1 Serving Cell Measurement Info Message') ]
    ...
    ws = wb.get_sheet_by_name('RL TDD TO 3G2G')
    #ws = wb.active
    ...
    for i in range(1, row_count + 1):
        index = "D" + str(i)
        if ws[index] == "Inter-system Cell Reselection To WCDMA":
            ws["A" + str(i)].fill = redFill
            ws["B" + str(i)].fill = redFill
            ws["C" + str(i)].fill = redFill
            ws["D" + str(i)].fill = redFill
            ws["E" + str(i)].fill = redFill
            ws["F" + str(i)].fill = redFill
            ws["G" + str(i)].fill = redFill
            ws["H" + str(i)].fill = redFill
